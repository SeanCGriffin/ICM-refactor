...
# Create project
open_project [file normalize "$BUILD_WORKSPACE/project/$BUILD.xpr"]



# Create 'synth_1' run (if not found)
# if {[string equal [get_runs -quiet synth_1] ""]} {
#   create_run -name synth_1 -part $part -flow {Vivado Synthesis Defaults} -strategy "Flow_RuntimeOptimized" -constrset constrs_1
# } else {
...
#   create_run -name impl_1 -part $part -flow {Vivado Implementation Defaults} -strategy "Flow_RuntimeOptimized" -constrset constrs_1 -parent_run synth_1
# } else {
